...
class BinaryTreeNode
{
    ...
    /**
     * entry is a (key, value) pair stored in this node. parent is the parent of
     ...
     **/
    BinaryTreeNode(Entry entry, BinaryTreeNode parent, BinaryTreeNode left, BinaryTreeNode right)
    {
        this.entry = entry;
        this.parent = parent;
        this.leftChild = left;
    ...
    /**
     * Express a BinaryTreeNode as a String. inorder traversal
     *
