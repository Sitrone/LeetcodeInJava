    ...
    while (node.parent != null) {
        ...
        else
        {
            if((node.parent.parent.leftChild != null && node == node.parent.parent.leftChild.leftChild) ||
              (node.parent.parent.rightChild != null && node == node.parent.parent.rightChild.rightChild))
            {
                zigZig(node);
            }
            else if((node.parent.parent.leftChild != null && node == node.parent.parent.leftChild.rightChild) ||
                    (node.parent.parent.rightChild != null && node == node.parent.parent.rightChild.leftChild))
            {
                zigZag(node);
            }
